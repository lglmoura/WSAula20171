...
RSpec.describe ProfessoresController, type: :controller do
  ...
  describe "GET #edit" do
    it "returns a success response" do
      professor = Professor.create! valid_attributes
      get :edit, params: {id: professor.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Professor" do
        expect {
          post :create, params: {professor: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {professor: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested professor" do
        professor = Professor.create! valid_attributes
        put :update, params: {id: professor.to_param, professor: new_attributes}, session: valid_session
        professor.reload
      ...
      it "redirects to the professor" do
        professor = Professor.create! valid_attributes
        put :update, params: {id: professor.to_param, professor: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        professor = Professor.create! valid_attributes
        put :update, params: {id: professor.to_param, professor: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested professor" do
      professor = Professor.create! valid_attributes
      expect {
        delete :destroy, params: {id: professor.to_param}, session: valid_session
      }.to change(Professor, :count).by(-1)
    end
