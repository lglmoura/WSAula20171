...
RSpec.describe DisciplinasController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      disciplina = Disciplina.create! valid_attributes
      get :show, params: {id: disciplina.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      disciplina = Disciplina.create! valid_attributes
      get :edit, params: {id: disciplina.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Disciplina" do
        expect {
          post :create, params: {disciplina: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {disciplina: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested disciplina" do
        disciplina = Disciplina.create! valid_attributes
        put :update, params: {id: disciplina.to_param, disciplina: new_attributes}, session: valid_session
        disciplina.reload
      ...
      it "redirects to the disciplina" do
        disciplina = Disciplina.create! valid_attributes
        put :update, params: {id: disciplina.to_param, disciplina: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        disciplina = Disciplina.create! valid_attributes
        put :update, params: {id: disciplina.to_param, disciplina: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested disciplina" do
      disciplina = Disciplina.create! valid_attributes
      expect {
        delete :destroy, params: {id: disciplina.to_param}, session: valid_session
      }.to change(Disciplina, :count).by(-1)
    end
